...
if (isset($_POST['utilisateur']) && isset($_POST['mdp'])) {
    ...
    $query = "SELECT * FROM Login WHERE utilisateur = '$utilisateur' and mdp = '$mdp'";
    $result = mysqli_query($conn, $query);

    if (mysqli_num_rows($result) == 1) {
        // Si l'utilisateur est authentifié, stocker les informations de l'utilisateur dans les variables de session
